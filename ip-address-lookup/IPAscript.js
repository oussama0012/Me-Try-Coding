        ...
        try {
            ...
            if (isIPWhoisAPI) {
                ...
                networkInfo.innerHTML = `
                    ...
                    <strong>Network:</strong> ${data.ip || 'N/A'}/${data.cidr || 'N/A'}<br>
                ...
                typeInfo.innerHTML = `
                    ...
                    <strong>Currency:</strong> ${data.currency || 'N/A'}
                `;
            } else {
...
Network: ${isIPWhoisFormat ? `${currentIPData.ip || 'N/A'}/${currentIPData.cidr || 'N/A'}` : (currentIPData.network || 'N/A')}
...
Type: ${isIPWhoisFormat ? (currentIPData.type || 'N/A') : 'N/A'}
Postal Code: ${currentIPData.postal || 'N/A'}
Currency: ${isIPWhoisFormat ? (currentIPData.currency || 'N/A') : (currentIPData.currency_name || 'N/A')}
